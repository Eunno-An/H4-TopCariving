...
class ModalPresentationController: UIPresentationController {
    override var frameOfPresentedViewInContainerView: CGRect {
        ...
        containerView.backgroundColor = UIColor(cgColor: .init(red: 24/255, green: 24/255, blue: 24/255, alpha: 0.6))
        let modalSize = CGSize(width: containerView.bounds.width * 0.89, height: containerView.bounds.height * 0.387)
        let modalOrigin = CGPoint(x: (containerView.bounds.width - modalSize.width) / 2,

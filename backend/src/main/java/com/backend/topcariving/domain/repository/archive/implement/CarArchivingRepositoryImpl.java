...
import com.backend.topcariving.domain.repository.archive.mapper.CarDTORowMapper;
...
public class CarArchivingRepositoryImpl implements CarArchivingRepository {
	...
	public CarArchiving save(CarArchiving carArchiving) {
		...
		parameters.put("archiving_type", carArchiving.getArchivingType().getName());
	...
	@Override
	public List<CarArchiving> findByCarOptionIdsAndArchivingTypes(List<Long> carOptionIds, List<ArchivingType> archivingTypes, Integer pageNumber, Integer pageSize) {
		List<String> archivingTypesToString = archivingTypes.stream()
			.map(ArchivingType::getName)
		...
		paramMap.put("archivingTypes", archivingTypesToString);
	...
	@Override
	public List<CarArchiving> findByArchivingTypes(List<ArchivingType> archivingTypes, Integer pageNumber, Integer pageSize) {
		List<String> archivingTypesToString = archivingTypes.stream()
			.map(ArchivingType::getName)
			.collect(Collectors.toList());
